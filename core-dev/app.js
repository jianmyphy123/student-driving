...
const invitationController = require('./controllers/user')
...
app.use((req, res, next) => {
  if (req.path === '/api/upload') {
    next();
  } else if (req.path === '/change-rating') {
...
app.get('/lesson', lessonController.getLesson);
app.post('/change-rating', lessonController.changeRating);
app.get('/invitation', invitationController.getInvitation);
